        ...
        <div className="spons-message-cont mx-10 lg:w-2/3">
          <div className="message">
            ...
            >
              ...
              recognized Bitrust as a trusted and reliable entity but have also
              extended their support in forming strong partnerships. This
              collaborative effort reflects the high level of trust and
              credibility that Bitrust has garnered within the financial sector.
              Our commitment to excellence in testing and validation has earned
              us the respect and endorsement of key players in the industry,
              further solidifying our position as a leader in the field.
            </div>
          </div>
        </div>
